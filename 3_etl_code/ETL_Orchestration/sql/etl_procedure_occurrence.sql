...
# join longitudinal table with pre formated
  coTemp AS(
       SELECT ROW_NUMBER() OVER(PARTITION BY p.person_id ORDER by p.person_id,vo.visit_occurrence_id,ssfgcp.APPROX_EVENT_DAY) AS procedure_occurrence_id,
              ...
              /*CASE
                   WHEN ssfgcp.CODE1 IS NOT NULL AND ssfgcp.CODE2_ICD_CAUSE_NA IS NOT NULL AND ssfgcp.CODE3_ATC_CODE_NA IS NOT NULL THEN CONCAT('CODE1=',ssfgcp.CODE1,';CODE2=',ssfgcp.CODE2_ICD_CAUSE_NA,';CODE3=',ssfgcp.CODE3_ATC_CODE_NA)
                   WHEN ssfgcp.CODE1 IS NOT NULL AND ssfgcp.CODE2_ICD_CAUSE_NA IS NOT NULL AND ssfgcp.CODE3_ATC_CODE_NA IS NULL THEN CONCAT('CODE1=',ssfgcp.CODE1,';CODE2=',ssfgcp.CODE2_ICD_CAUSE_NA,';CODE3=')
                   WHEN ssfgcp.CODE1 IS NOT NULL AND ssfgcp.CODE2_ICD_CAUSE_NA IS NULL AND ssfgcp.CODE3_ATC_CODE_NA IS NOT NULL THEN CONCAT('CODE1=',ssfgcp.CODE1,';CODE2=;CODE3=',CODE3_ATC_CODE_NA)
                   WHEN ssfgcp.CODE1 IS NULL AND ssfgcp.CODE2_ICD_CAUSE_NA IS NOT NULL AND ssfgcp.CODE3_ATC_CODE_NA IS NOT NULL THEN CONCAT('CODE1=;CODE2=',ssfgcp.CODE2_ICD_CAUSE_NA,';CODE3=',ssfgcp.CODE3_ATC_CODE_NA)
                   WHEN ssfgcp.CODE1 IS NOT NULL AND ssfgcp.CODE2_ICD_CAUSE_NA IS NULL AND ssfgcp.CODE3_ATC_CODE_NA IS NULL THEN CONCAT('CODE1=',ssfgcp.CODE1,';CODE2;CODE3=')
