...
SELECT
'FinnGen data freeze 14' AS cdm_source_name,
'FinnGen-DF14' AS cdm_source_abbreviation,
...
CAST('2026-03-24' AS DATE) AS source_release_date, -- NB: Set this value to the day the source data was pulled
