...
-- measurement_concept_id
  COALESCE(mfrwsasci.concept_id_2, 0) measurement_concept_id,
-- measurement_date
  mfrwsasci.APPROX_EVENT_DAY AS measurement_date,
-- measurement_datetime
  mfrwsasci.APPROX_EVENT_DAY AS measurement_datetime,
-- measurement_time
  cast(cast(mfrwsasci.APPROX_EVENT_DAY AS datetime) AS time) measurement_time,
-- measurement_type_concept_id
...
-- measurement_source_concept_id
  COALESCE(CAST(mfrwsasci.omop_source_concept_id AS INT), 0) AS measurement_source_concept_id,
-- unit_source_value
