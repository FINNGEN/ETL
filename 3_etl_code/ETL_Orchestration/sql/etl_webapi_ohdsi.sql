/*
  Note: This is needed only after vocabulary-content has changed.

  Script is based on URL call
  https://atlas-demo.ohdsi.org/WebAPI/ddl/results


  Schema parameters have been substituted: 
  @results_schema = @schema_achilles
  @vocab_schema = @schema_vocab

  To index creation, added " IF NOT EXISTS "

*/



IF OBJECT_ID('@schema_achilles.cohort', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort
(
...
IF OBJECT_ID('@schema_achilles.cohort_censor_stats', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_censor_stats(
  cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);


IF OBJECT_ID('@schema_achilles.cohort_inclusion', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_inclusion(
  cohort_definition_id int NOT NULL,
...
IF OBJECT_ID('@schema_achilles.cohort_inclusion_result', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_inclusion_result(
  cohort_definition_id int NOT NULL,
...
IF OBJECT_ID('@schema_achilles.cohort_inclusion_stats', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_inclusion_stats(
  cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
IF OBJECT_ID('@schema_achilles.cohort_summary_stats', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_summary_stats(
  cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
...
IF OBJECT_ID('@schema_achilles.cohort_cache', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_cache (
...
IF OBJECT_ID('@schema_achilles.cohort_censor_stats_cache', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_censor_stats_cache (
  design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);


IF OBJECT_ID('@schema_achilles.cohort_inclusion_result_cache', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_inclusion_result_cache (
  design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
...
IF OBJECT_ID('@schema_achilles.cohort_inclusion_stats_cache', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_inclusion_stats_cache (
  design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
IF OBJECT_ID('@schema_achilles.cohort_summary_stats_cache', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_summary_stats_cache (
  design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
...
IF OBJECT_ID('@schema_achilles.feas_study_inclusion_stats', 'U') IS NULL
CREATE TABLE @schema_achilles.feas_study_inclusion_stats(
...
IF OBJECT_ID('@schema_achilles.feas_study_index_stats', 'U') IS NULL
CREATE TABLE @schema_achilles.feas_study_index_stats(
  study_id int NOT NULL,
  person_count bigint NOT NULL,
...
IF OBJECT_ID('@schema_achilles.feas_study_result', 'U') IS NULL
CREATE TABLE @schema_achilles.feas_study_result(
  study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);
...
IF OBJECT_ID('@schema_achilles.heracles_analysis', 'U') IS NULL
CREATE TABLE @schema_achilles.heracles_analysis
(
	analysis_id int,
...
IF OBJECT_ID('@schema_achilles.HERACLES_HEEL_results', 'U') IS NULL
CREATE TABLE @schema_achilles.HERACLES_HEEL_results 
( 
...
IF OBJECT_ID('@schema_achilles.heracles_results', 'U') IS NULL
create table @schema_achilles.heracles_results
(
	cohort_definition_id int,
	analysis_id int,
...
--HINT PARTITION(cohort_definition_id int)
--HINT BUCKET(analysis_id, 64)
IF OBJECT_ID('@schema_achilles.heracles_results_dist', 'U') IS NULL
create table @schema_achilles.heracles_results_dist
(
	cohort_definition_id int,
	analysis_id int,
	stratum_1 varchar(255),
...
IF OBJECT_ID('@schema_achilles.heracles_periods', 'U') IS NULL
CREATE TABLE @schema_achilles.heracles_periods
(
	period_id int,
  period_order int,
...
IF OBJECT_ID('@schema_achilles.cohort_sample_element', 'U') IS NULL
CREATE TABLE @schema_achilles.cohort_sample_element(
...
IF OBJECT_ID('@schema_achilles.ir_analysis_dist', 'U') IS NULL
CREATE TABLE @schema_achilles.ir_analysis_dist (
...
IF OBJECT_ID('@schema_achilles.ir_analysis_result', 'U') IS NULL
CREATE TABLE @schema_achilles.ir_analysis_result(
  analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
IF OBJECT_ID('@schema_achilles.ir_analysis_strata_stats', 'U') IS NULL
CREATE TABLE @schema_achilles.ir_analysis_strata_stats(
  analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
IF OBJECT_ID('@schema_achilles.ir_strata', 'U') IS NULL
CREATE TABLE @schema_achilles.ir_strata(
  analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
...
IF OBJECT_ID('@schema_achilles.cc_results', 'U') IS NULL
CREATE TABLE @schema_achilles.cc_results
(
...
IF OBJECT_ID('@schema_achilles.pathway_analysis_codes', 'U') IS NULL
CREATE TABLE @schema_achilles.pathway_analysis_codes
(
...
IF OBJECT_ID('@schema_achilles.pathway_analysis_events', 'U') IS NULL
CREATE TABLE @schema_achilles.pathway_analysis_events
(
	pathway_analysis_generation_id BIGINT NOT NULL,
...
IF OBJECT_ID('@schema_achilles.pathway_analysis_paths', 'U') IS NULL
CREATE TABLE @schema_achilles.pathway_analysis_paths
(
	pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
  step_1 BIGINT,
...
IF OBJECT_ID('@schema_achilles.pathway_analysis_stats', 'U') IS NULL
CREATE TABLE @schema_achilles.pathway_analysis_stats
(
  pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
...
IF OBJECT_ID('@schema_achilles.concept_hierarchy', 'U') IS NULL
CREATE TABLE @schema_achilles.concept_hierarchy
(
  concept_id             INT,
...
/***********************************************************/
TRUNCATE TABLE @schema_achilles.concept_hierarchy;
...
TRUNCATE TABLE @schema_achilles.heracles_analysis;
...
TRUNCATE TABLE @schema_achilles.heracles_periods;
...
CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_DEF_ID ON @schema_achilles.HERACLES_RESULTS_DIST (cohort_definition_id);

CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_ID_ANALYSIS_ID ON @schema_achilles.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id);

CREATE INDEX IF NOT EXISTS  HRD_IDX_COHORT_DEF_ID_DT ON @schema_achilles.HERACLES_RESULTS_DIST (cohort_definition_id, last_update_time);

CREATE INDEX IF NOT EXISTS  HRD_IDX_COHORT_ID_FIRST_RES ON @schema_achilles.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX IF NOT EXISTS  HR_IDX_COHORT_DEF_ID ON @schema_achilles.HERACLES_RESULTS (cohort_definition_id);

CREATE INDEX IF NOT EXISTS  HR_IDX_COHORT_ID_ANALYSIS_ID ON @schema_achilles.HERACLES_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX IF NOT EXISTS  HR_IDX_COHORT_ANALYSIS_CONCEPT ON @schema_achilles.HERACLES_RESULTS (cohort_definition_id, analysis_id) WHERE stratum_2 <> '';

CREATE INDEX IF NOT EXISTS  HR_IDX_COHORT_DEF_ID_DT ON @schema_achilles.HERACLES_RESULTS (cohort_definition_id, last_update_time);

CREATE INDEX IF NOT EXISTS  HR_IDX_COHORT_ID_FIRST_RES ON @schema_achilles.HERACLES_RESULTS (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX IF NOT EXISTS  HH_IDX_COHORT_ID_ANALYSIS_ID ON @schema_achilles.HERACLES_HEEL_RESULTS (cohort_definition_id, analysis_id);


CREATE INDEX IF NOT EXISTS  idx_heracles_periods_startdate ON @schema_achilles.heracles_periods (period_start_date);

CREATE INDEX IF NOT EXISTS  idx_heracles_periods_end_date ON @schema_achilles.heracles_periods (period_end_date);


CREATE INDEX IF NOT EXISTS  idx_cohort_sample_element_rank ON @schema_achilles.cohort_sample_element (cohort_sample_id, rank_value);

CREATE INDEX IF NOT EXISTS  idx_pathway_events_combo_id ON @schema_achilles.pathway_analysis_events (combo_id);