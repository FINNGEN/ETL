...
-- observation_concept_id
  COALESCE(ofrwsasci.concept_id_2, 0) AS observation_concept_id,
-- observation_date
  ofrwsasci.APPROX_EVENT_DAY AS observation_date,
-- observation_datetime
  CAST(ofrwsasci.APPROX_EVENT_DAY AS DATETIME) AS observation_datetime,
-- observation_type_concept_id
...
-- observation_source_concept_id
  COALESCE(CAST(ofrwsasci.omop_source_concept_id AS int), 0) AS observation_source_concept_id,
-- unit_source_value
