...
#visit_source_value,
  CASE
    WHEN SOURCE IN ('BIOBANK','PURCH','PRESCRIPTION','DELIVERY','PRESCRIPTION_DELIVERY','DELIVERY_KELA','PRESCRIPTION_DELIVERY_KELA',
                    'VACCINATION', 'PRESCRIPTION_DELIVERY_VACCINATION', 'PRESCRIPTION_DELIVERY_KELA_VACCINATION', 'KELA_VACCINATION',
                    'HOSPITAL_MEDICATION', 'RHEUMA', 'OTHER_DRUGS') THEN CONCAT('SOURCE=',vfrwssvtf.SOURCE,';INDEX=')
