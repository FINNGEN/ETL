...
# TESTS BMI AND HEIGHT CODES MAPPING --------------------------------------------------------------------------------------

# Declare Test - 0807 - BMI and Height codes will be mapped to proper standard codes
declareTest(0807, "etl_measurement BMI and Height codes will be mapped to standard codes")
...
expect_measurement(
  person_id = lookup_person("person_id", person_source_value="FG0807001"),
  visit_occurrence_id = lookup_visit_occurrence("visit_occurrence_id",
                                                person_id = lookup_person("person_id",person_source_value = "FG0807001"),
...
# Declare Test - 0808 - Only Height codes will be mapped to standard codes When Weight variable is missing
declareTest(0808, "etl_measurement adds one row for Height codes ony which will be mapped to standard codes")
...
expect_measurement(
  person_id = lookup_person("person_id", person_source_value="FG0808001"),
  visit_occurrence_id = lookup_visit_occurrence("visit_occurrence_id",
                                                person_id = lookup_person("person_id",person_source_value = "FG0808001"),
                                                visit_source_value = "SOURCE=BIOBANK;INDEX="),
  measurement_concept_id = as_subquery(4177340),
...
# Declare Test - 0809 - No BMI or Height codes will be mapped to standard codes When both Height and Weight variables are missing
declareTest(0809, "etl_measurement DOESNOT insert a row when both height and weight variables are missing")
...
expect_measurement(
  person_id = lookup_person("person_id", person_source_value="FG0809001")
)
